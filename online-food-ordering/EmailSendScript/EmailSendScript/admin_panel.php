...
<!-- Navbar -->
      ...
      <div class="container-fluid px-2 py-2" >
         <h2 class="text-dark"> Welcome  to Email-Quantum [Admin: <?php echo $_SESSION['username']; ?>] </h2>
            ...
            <table class="table table-striped table-hover">
                <thead>
                    <tr>
                            ...
                            <th scope="col">Created_By_Username </th>      
                ...
                <tbody>
                     <?php
$ret=mysqli_query($con,"select * from ckeditor ORDER BY `id` DESC" );
$cnt=1;
$row=mysqli_num_rows($ret);
if($row>0){
while ($row=mysqli_fetch_array($ret)) {
...
<!--Fetch the Records -->
                    <tr>
                                ...
                                <td><?php  echo $row['usernamecreatedByWhom']; ?></td>
                                <td><?php  echo $row['created']; ?></td>
                                
                        <td>
 
                        <a href="admin_panel.php?delid2=<?php echo ($row['id']);?>" class="delete" title="Delete" data-toggle="tooltip" onclick="return confirm('Do you really want to Delete ?');"><i class="material-icons">&#xE872;</i></a>
