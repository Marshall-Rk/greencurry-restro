        ...
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                     <?php
                     $loggedIn  =$_SESSION['id'];
$ret=mysqli_query($con,"select * from ckeditor WHERE `idofuser` = $loggedIn" );
$cnt=1;
...
<!--Fetch the Records -->
                    <tr>
                        ...
                        <a href="editmssg.php?editid=<?php echo htmlentities ($row['id']);?>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
