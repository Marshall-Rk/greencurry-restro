...
$username = $password = $email = $mobile_number =$confirm_password = "";
$username_err = $password_err = $email_err = $mobile_number_err = $confirm_password_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  $mobile_number = $_POST['mobile_number'];
    ...
    if(empty($username_err) && empty($password_err) && empty($email_err) && empty($mobile_number_err) && empty($confirm_password_err)){
        
       
        $sql = "INSERT INTO pixelemail (username, email,mobile_number, password) VALUES (?,?,?,?)";
         
        if($stmt = mysqli_prepare($link, $sql)){
          
            mysqli_stmt_bind_param($stmt, "ssss", $param_username,$param_email,$param_mobile_number, $param_password);
        ...
        ?>
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
              ...
              <div class="form-group second ">
                ...
                <input type="int" name="mobile_number" class="form-control <?php echo secure((!empty($mobile_number_err))) ? 'is-invalid' : ''; ?>">
