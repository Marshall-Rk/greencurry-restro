...
if(isset($_POST['submit'] ))
{
	...
	$check_username= mysqli_query($con, "SELECT username FROM pixelemail where username = '".$_POST['username']."' ");
	$check_email = mysqli_query($con, "SELECT email FROM pixelemail where email = '".$_POST['email']."' ");
	...
	$mql = "INSERT INTO pixelemail(username,f_name,l_name,email,phone,password,address) VALUES('".$_POST['uname']."','".$_POST['fname']."','".$_POST['lname']."','".$_POST['email']."','".$_POST['phone']."','".md5($_POST['password'])."','".$_POST['address']."')";
	mysqli_query($db, $mql);
