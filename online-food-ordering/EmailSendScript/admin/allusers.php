    ...
    <div id="main-wrapper">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Recipient-Emails</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="allemaillist.php">Recipient-Emails</a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <h3 class="text-dark ">ADMIN -<span class="text-success"> <?php echo $_SESSION['username']; ?> </span></h3></div>
...
?>
		...
		<tbody>
			<?php
				...
				$query=$con->query("select * from `pixelemail`");
				while($row=$query->fetch_array()){
					?>
						<tr>
							<td class="text-dark"><?php echo $row['username']; ?></td>
							<td class="text-success"><?php echo date('D, M j, Y H:i:s', strtotime($row["date"])); ?></td>
                          
                            <td class="text-success"><?php echo $row['accstatus']; ?>
                           
                            <a href="edit.php?editid=<?php echo htmlentities ($row['id']);?>" class="edit" title="Edit" data-toggle="tooltip"> <i class="fa fa-pencil-square-o text-dark" aria-hidden="true"></i></a>
							...
							<td class="text-danger">
								<?php
									...
									$expire=date('D, M j, Y H:i:s', strtotime($row['date']. '+23 days'));
                                    echo $expire;
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo ' <tr>
																								...
																								<td>'.$rows['AadharCard_number'].'</td>
                                                                                                
                                                                                                <td>
                                                                                                <div class="col-md-3 col-lg-8 m-b-10">
                                                                                                
																								<center>
                                                                                                <img id="myImg" src="../uploaded/'.$rows['image'].'" 
                                                                                                class="img-responsive radius zoom" style="width:200px; height:100px"/>
                                                                                                </center>
																								</div>
