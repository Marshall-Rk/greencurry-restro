...
<body class="fix-header fix-sidebar">
   ...
   $sql = "SELECT id FROM restro ";
   
   if ($result = mysqli_query($connection_mysql,$sql)){
      $rowcount = mysqli_num_rows($result);
      
      printf("Total Booking's - %d \n",$rowcount);
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo ' <tr><td>'.$rows['fullname'].'</td>
																								<td>'.$rows['email'].'</td>
																								<td>'.$rows['phone1'].'</td>
																								<td>'.$rows['date'].'</td>
																								<td>'.$rows['time'].'</td>
																								<td>'.$rows['person'].'</td>	
                                                                                                <td>'.$rows['restaurant'].'</td>	
                                                                                                																							
																								<td>'.$rows['Time_of_feedback'].'</td>
