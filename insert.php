...
<div class="signup-form">
    <form  method="POST">
        ...
        <div class="form-group">
			<div class="row">
				<div class="col"><input type="text" class="form-control" name="fullname" placeholder="FullName" required="true"></div>
	...
	<div class="text-center">View Aready Inserted Data!!  <a href="admin-dashboard.php">View</a></div>
</div>
</body>
</html>